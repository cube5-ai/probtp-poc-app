"""Summary prompt template for generating high-level comparison overview across all categories."""
...
def create_summary_prompt(
    ...
    Args:
        category_analyses: List of analysis outputs (subset of AnalysisOutput fields):
...
This summary serves TWO distinct purposes (like the category analyses):
